            ...
            <ScrollView>
                ...
                <View className="mx-[32px] pt-[20px]">
                    ...
                    <View className="bg-white w-full h-full mt-[36px] flex flex-row">
                        ...
                        {/* Plan */}
                        <View className="bg-white w-[295px] h-auto ml-3 gap-y-3">
                            {/* Place */}
                            <View className="bg-gray-dark h-auto rounded-[30px] p-6">
                            ...
                            {/* Restaurant */}
                            <View className="bg-gray-light h-auto rounded-[30px] p-6">
                                <View className="flex flex-row items-center justify-between">
                                    <View className="flex flex-row items-center">
